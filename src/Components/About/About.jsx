...
//     className: "top-2 sm:top-4 left-1/2 -translate-x-1/2 animate-float1",
//   },
//   {
//     icon: <SiExpress className="text-white text-2xl sm:text-3xl" />,
//     className: "top-8 sm:top-12 right-4 sm:right-8 animate-float2",
//   },
//   {
//     icon: <SiNextdotjs className="text-white text-2xl sm:text-3xl" />,
//     className: "top-1/2 right-0 -translate-y-1/2 animate-float1",
//   },
//   {
//     icon: <FaNodeJs className="text-green-500 text-2xl sm:text-3xl" />,
//     className: "bottom-8 sm:bottom-12 right-4 sm:right-8 animate-float2",
//   },
//   {
//     icon: <FaDatabase className="text-sky-400 text-2xl sm:text-3xl" />,
//     className: "bottom-8 sm:bottom-12 left-4 sm:left-8 animate-float1",
//   },
// ];
...
//   // mobile e animation off - just static render
...
//                       src={src}
//                       alt=""
//                       className="w-8 h-8 sm:w-9 sm:h-9 rounded-full border-2 border-[#0a0c0a] object-cover"
//                     />
//                   ))}
//                 </div>
//                 <div className="text-sm">
...
//           <motion.div {...orbitWrapperMotionProps} className="flex justify-center">
//             <motion.div
...
//               <div className="absolute inset-6 sm:inset-8 lg:inset-10 rounded-full border border-violet-500/20 shadow-[0_0_40px_rgba(139,92,246,.15)]"></div>

//               <div className="absolute inset-12 sm:inset-16 lg:inset-20 rounded-full border border-cyan-400/20 shadow-[0_0_30px_rgba(34,211,238,.15)]"></div>

//               <div className="absolute inset-20 sm:inset-28 lg:inset-32 rounded-full border border-slate-700"></div>

//               <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 sm:w-32 sm:h-32 lg:w-36 lg:h-36 rounded-full bg-emerald-500/10 blur-2xl"></div>

//               <motion.div
//                 {...iconMotionProps}
//                 className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20"
//               >
//                 <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-2xl border border-white/10 bg-[#171717]/90 backdrop-blur-xl shadow-[0_0_40px_rgba(0,0,0,.5)] flex justify-center items-center">
//                   <FaCode className="text-2xl sm:text-3xl lg:text-4xl text-white" />
//                 </div>
//               </motion.div>
...
//                   className={`absolute ${item.className}`}
//                 >
//                   <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl bg-[#1a1a1a]/80 backdrop-blur-xl border border-white/10 shadow-[0_0_25px_rgba(255,255,255,.05)] flex items-center justify-center hover:scale-110 transition duration-300">
//                     {item.icon}
//                   </div>
//                 </motion.div>
//               ))}
